...
<head>
  <meta charset="UTF-8">
  <title><?= htmlspecialchars($categoria) ?> - Particular</title>
...
<h1><?= htmlspecialchars($categoria) ?> - Precios Particular</h1>
...
<?php else: ?>
  <div class="alert alert-warning text-center">
    No se encontraron resultados en esta categoría de Particular.
  </div>
<?php endif; ?>

<script>
// ⚠️ Este valor debes cambiar según la página
const tipoPrevision = "PARTICULAR"; // En refo.php => "FONASA", en repa.php => "PARTICULAR"

// Limpiar otras claves al cambiar de previsión
