...
<head>
  <meta charset="UTF-8">
  <title><?= htmlspecialchars($categoria) ?> - Fonasa</title>
...
<h1><?= htmlspecialchars($categoria) ?> - Precios Fonasa</h1>
...
<?php else: ?>
  <div class="alert alert-warning text-center">
    No se encontraron resultados en esta categoría de Fonasa.
  </div>
<?php endif; ?>

<script>
// ⚠️ Este valor debes cambiar según la página
const tipoPrevision = "FONASA"; // En refo.php => "FONASA", en repa.php => "PARTICULAR"
